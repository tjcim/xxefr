...
<%@ include file="../common/nav.jspf" %>
	<div class="">
		<div class="container pt-5 pb-5" id="content">
			...
			<p>It uses the guidance from OWASP found here: <a href="https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html">https://cheatsheetseries.owasp.org/cheatsheets/XML_External_Entity_Prevention_Cheat_Sheet.html</a>
			<hr/>
			<div>
